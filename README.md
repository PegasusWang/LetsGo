...
本电子书主要面向有一定其他编程语言开发经验的开发者快速上手 go，不会涉及到一些非常具体和细节的问题，非零基础教程。 
比如如何下载 IDE，如何导出环境变量等， 编程新手可以先补一补开发基础。
本小书会涉及到以下内容，将会长期不间断更新文章和小视频（除非笔者又换工作学习别的技术栈了）:
...
- go web 开发：包含常用的 go web 框架，web 开发常用的第三方库(http/mysql/redis/kafka)快速上手开发
- go 最佳实践: 比如代码组织，单元测试，性能测试，工程实践等
- go 高级特性: go 的一些高级语法特性
- go 并发编程: go 的一大卖点，学习如何实现高性能 web 后端
...
- 多写多练。光看书是学不会编程的，练习到手熟。书上的例子一定要自己亲自尝试编写和实现，千万不要只看不敲
- 照葫芦画瓢，一开始学会模仿别人的写法。看源码，学习优秀的设计和写法，慢慢你就有感觉了
- 做项目，总结，输出。巩固所学知识，技术分享和输出。费曼学习法，加深你的理解层次和记忆效果
